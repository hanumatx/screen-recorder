...
import os
import hashlib
from synced_recorder import SyncedRecorderPage
...
class LoginPage:
    def __init__(self, root):
        ...
        tk.Label(root, text="Screen recorder!", font=("Arial", 32), bg="#282c34", fg="#61dafb").pack(pady=10)
    ...
    def open_recorder_page(self):
        ...
        SyncedRecorderPage(recorder_window)  # Use SyncedRecorderPage here
